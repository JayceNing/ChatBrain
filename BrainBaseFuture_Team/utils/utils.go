...
func MailSendCode(mail string, code string) error {
	e := email.NewEmail()
	e.From = "脑基未来 Jayce Ning <nxybupt@bupt.edu.cn>"
	e.To = []string{mail}
	e.Subject = "电子邮箱验证码"
	...
	err := e.SendWithTLS("smtp.exmail.qq.com:465", smtp.PlainAuth("", "nxybupt@bupt.edu.cn", config.MailPassword, "smtp.exmail.qq.com"),
